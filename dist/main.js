...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _getMeal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getMeal.js */ \"./src/Modules/getMeal.js\");\n/* harmony import */ var _userApi__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./userApi */ \"./src/Modules/userApi.js\");\n/* harmony import */ var _mealCounte_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mealCounte.js */ \"./src/Modules/mealCounte.js\");\n/* eslint-disable */\r\n\r\n\r\n\r\n\r\n\r\nconst foodItemsDiv = document.getElementById(\"food-items\");\r\n// event listeners\r\nfoodItemsDiv.addEventListener(\"click\", _getMeal_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\r\n\r\nconst foodsUI = async () => {\r\n  fetch(\"https://www.themealdb.com/api/json/v1/1/categories.php\")\r\n    .then((res) => res.json())\r\n    .then((data) => {\r\n      (0,_userApi__WEBPACK_IMPORTED_MODULE_1__.getLikes)().then((datalikes) => {\r\n        let html = \"\";\r\n        data.categories.forEach((item) => {\r\n          const arrLikes = datalikes.filter(\r\n            (item) => item.item_id === item.idcategories\r\n          );\r\n\r\n          // ckeck if the objct is empty\r\n          let pickLikes = \"\";\r\n          if (arrLikes.length !== 0) {\r\n            pickLikes = arrLikes[0].likes;\r\n          }\r\n\r\n          html += `\r\n        \r\n          <section class=\"features\">\r\n      <div class='meal-item' data-id = '${item.idCategory}'> \r\n        <div class = 'meal-img'>     \r\n          <img src='${item.strCategoryThumb}'>\r\n        </div>\r\n        <div class = 'involvement'> \r\n        <p><p>\r\n      \r\n        </div>\r\n        <p>${item.strCategory}</p>\r\n        <div class = 'meal-name'> \r\n          <p> ${item.strCategoryDescription.substr(0, 45)}...</p>\r\n          \r\n        </div>\r\n        <code><a>${pickLikes}  <i class='fa-regular fa-heart' id='like-${\r\n            item.idCategory\r\n          }'></i>  Like</a></code>\r\n      </div>\r\n        <button class = 'comment-btn'>Comment</button>\r\n\r\n      </section>\r\n      `;\r\n        });\r\n        foodItemsDiv.innerHTML = html;\r\n      });\r\n    });\r\n};\r\n\r\nsetTimeout(() => {\r\n  const total = (0,_mealCounte_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\r\n  const counter = document.getElementById(\"ourFood\");\r\n  counter.innerHTML = `Meals ${total}`;\r\n}, 1500);\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (foodsUI);\r\n\n\n//# sourceURL=webpack://javascript-capstone-project/./src/Modules/displayUi.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addLike\": () => (/* binding */ addLike),\n/* harmony export */   \"getLikes\": () => (/* binding */ getLikes)\n/* harmony export */ });\n/* harmony import */ var _displayUi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./displayUi */ \"./src/Modules/displayUi.js\");\n/* eslint-disable */\r\n\r\n\r\nconst url =\r\n  \"https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/\";\r\nconst key = \"4ZfW9Nw9KyQJZ8SztYPH\";\r\n\r\nconst getLikes = async () => {\r\n  const result = await fetch(`${url}${key}/likes`);\r\n  const data = await result.json();\r\n  return data;\r\n};\r\n\r\nconst addLike = async (id) => {\r\n  const body = JSON.stringify({ item_id: id });\r\n  const headers = { \"Content-type\": \"application/json; charset=UTF-8\" };\r\n  /* eslint-disable */\r\n\r\n  result = await fetch(`${url}${key}/likes`, {\r\n    method: \"POST\",\r\n    body,\r\n    headers,\r\n  });\r\n  (0,_displayUi__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\r\n};\r\n\r\n\n\n//# sourceURL=webpack://javascript-capstone-project/./src/Modules/userApi.js?");
...
eval("module.exports = __webpack_require__.p + \"e9728e19cac71bff5f23.jpg\";\n\n//# sourceURL=webpack://javascript-capstone-project/./Image/new.jpg?");

/***/ }),

/***/ "./Image/nordwood-themes-Tmz8FThN_BE-unsplash.jpg":
/*!********************************************************!*\
  !*** ./Image/nordwood-themes-Tmz8FThN_BE-unsplash.jpg ***!
  \********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"be1f81866dca98a0bd9c.jpg\";\n\n//# sourceURL=webpack://javascript-capstone-project/./Image/nordwood-themes-Tmz8FThN_BE-unsplash.jpg?");
